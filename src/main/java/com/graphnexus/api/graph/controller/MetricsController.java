...
public class MetricsController {
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "PageRank 结果列表"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "B0001 系统内部异常 / Neo4j GDS 计算失败")
    })
    @GetMapping("/pagerank")
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "度中心性结果列表"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "B0001 系统内部异常 / Neo4j GDS 计算失败")
    })
    @GetMapping("/degree")
