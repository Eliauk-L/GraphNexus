...
public class ExtractionPromptBuilder {
    ...
    public String buildSystemPrompt() {
        return """
                ...
                5. 每类至少返回 1 条，实在没有返回空数组 []
                6. **仅输出纯 JSON，禁止使用 markdown 代码块包裹**
                7. JSON 顶层字段名必须为：entities, knowledgePoints, categories, alignments, entityRelations, prerequisites, categoryRelations
                """;
    }
