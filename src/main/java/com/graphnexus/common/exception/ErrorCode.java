...
public enum ErrorCode {
    ...
    /** 配置值类型不匹配 */
    A0031("A0031", HttpStatus.BAD_REQUEST, "配置值类型不匹配，请检查输入格式"),

    /** 配置值不能为空 */
    A0032("A0032", HttpStatus.BAD_REQUEST, "配置值不能为空"),

    /** 配置值超出允许范围 */
    A0033("A0033", HttpStatus.BAD_REQUEST, "配置值超出允许范围，请检查约束条件"),

    /** 文件名非法（含路径遍历字符） */
    A0034("A0034", HttpStatus.BAD_REQUEST, "文件名包含非法字符"),

    /** 文档知识点已关联考试，需先删除考试记录 */
    A0035("A0035", HttpStatus.CONFLICT, "该文档的知识点已关联考试记录，请先删除相关考试后再删除文档"),
