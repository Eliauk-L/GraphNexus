...
public enum EntityType {
    ...
    /** 示例文本 — 与 LLM Prompt 中"（如 ...）"对应，供 prompt 实体类型段派生（AC-2 单一来源） */
    private final String example;

    EntityType(String value, String displayName, String description, String example) {
        this.value = value;
